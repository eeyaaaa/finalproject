...
$( document ).ready( function() {
	...
	$("#pwdCheckBtn").click(function(){
		...
		$.ajax({
			url : "/finalproject/mypage/checkPwd",
			type : "POST",
			data : password,
			...
			success : function(data){
				...
				if(data == 0){
					location.href="/finalproject/mypage/updateInfo";
				}else if(data == 1){
	...
	$("#updatePwdBtn").click(function(){
		...
		$.ajax({
			url : "/finalproject/mypage/updatePwd",
			type : "POST",
			...
			success : function(data){
				...
				if(data ==0){
					location.href="/finalproject/mypage/updatePwdComplite";
				}else{
